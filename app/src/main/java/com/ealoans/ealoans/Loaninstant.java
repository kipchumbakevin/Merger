...
public class Loaninstant extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView = new AdView(Loaninstant.this, getString(R.string.banner), AdSize.BANNER_HEIGHT_50);
        ...
        // Request an ad
        adView.loadAd();
        interstitialAd = new InterstitialAd(Loaninstant.this, getString(R.string.interstitial));
        ...
        interstitialAdListener = new InterstitialAdListener() {
            ...
            public void onInterstitialDismissed(Ad ad) {
                ...
                Intent intent = new Intent(Loaninstant.this,India.class);

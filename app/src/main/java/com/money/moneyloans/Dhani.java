...
public class Dhani extends AppCompatActivity {
    ...
    String content = "<h1>Fast Cash Loans</h1>\n" +
            "<p>Subscribe to dhani One Freedom and get Zero Interest Credit Lines upto ₹25,000 instantly.</p>\n \n"+
            "        <p><b>Eligibility</b>\n" +
            "        \n" +
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView = new AdView(Dhani.this, getString(R.string.banner), AdSize.BANNER_HEIGHT_50);
        ...
        // Request an ad
        adView.loadAd();
        interstitialAd = new InterstitialAd(Dhani.this, getString(R.string.interstitial));
        ...
        interstitialAdListener = new InterstitialAdListener() {
            ...
            public void onInterstitialDismissed(Ad ad) {
                ...
                //  Log.e(TAG, "Interstitial ad dismissed.");
                    ...
                    Intent intent = new Intent(Dhani.this,India.class);
